...
namespace MethodInterceptionTestsRunner
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            const string testAssemblyLocation = @"C:\Projects\github\SharpMock\Tests\IntegrationTests\bin\Debug\IntegrationTests.dll";
            const string assemblyToModifyLocation = @"C:\Projects\github\SharpMock\Tests\IntegrationTests\bin\Debug\Scenarios.dll";
