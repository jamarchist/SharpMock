...
namespace MethodInterceptionTestsRunner
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            const string testAssemblyLocation = @"C:\Projects\SharpMock\Tests\MethodInterceptionTests\bin\Debug\MethodInterceptionTests.dll";
            const string assemblyToModifyLocation = @"C:\Projects\SharpMock\Tests\MethodInterceptionTests\bin\Debug\Scenarios.dll";
